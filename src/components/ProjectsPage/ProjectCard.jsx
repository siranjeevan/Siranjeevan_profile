            ...
            <motion.span
              ...
              animate={isTouchDevice ? {
                ...
                transition: { 
                  ...
                  y: { delay: index * 0.1 },
                  scale: { duration: 2, repeat: Infinity, delay: index * 0.2, ease: "easeInOut" }
                }
              } : { opacity: 1, y: 0 }}
        ...
        <div className="flex gap-4 pt-2">
          {project.liveLink ? (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              animate={isTouchDevice ? {
                boxShadow: ["0 5px 15px rgba(139, 92, 246, 0.2)", "0 10px 25px rgba(139, 92, 246, 0.4)", "0 5px 15px rgba(139, 92, 246, 0.2)"],
                transition: { duration: 2, repeat: Infinity, ease: "easeInOut" }
              } : {}}
            >
